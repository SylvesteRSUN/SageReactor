...
void UOllamaProvider::SendRequest(const FLLMRequest& Request, const FOnLLMRequestComplete& OnComplete)
{
	...
	HttpRequest->OnProcessRequestComplete().BindUObject(this, &UOllamaProvider::OnHttpRequestComplete, OnComplete);
...
void UOllamaProvider::OnHttpRequestComplete(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FOnLLMRequestComplete OnComplete)
{
